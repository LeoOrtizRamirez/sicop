...
$url = 'https://www.sicop.go.cr/moduloOferta/search/EP_SEJ_COQ601.jsp?cartelTestYn=Y&cartelNm=&proceType=&cartelInstCd=&instNm=&regDtFrom='.$desde_publicacion.'&regDtTo='.$hasta_apertura.'&openbidDtFrom='.$desde_apertura.'&openbidDtTo='.$hasta_apertura.'&instCartelNo=&cartelNo=&prodNm=&prodUnitUserYn=&prodUnit=&cateId=&prodCate=&biddocRcvYn=Y';
...
print_r($pages);
for ($i=2; $i < $pages; $i++) { 
    saveData('https://www.sicop.go.cr/moduloOferta/search/EP_SEJ_COQ601.jsp?cateId=&proceType=&biddocRcvYn=Y&regDtTo='.$hasta_apertura.'&regDtFrom='.$desde_publicacion.'&instNm=&prodUnitUserYn=&openbidDtTo='.$hasta_apertura.'&prodNm=&openbidDtFrom='.$desde_apertura.'&instCartelNo=&cartelInstCd=&cartelTestYn=Y&cartelNo=&cartelNm=&prodCate=&prodUnit=&page_no='.$i);
